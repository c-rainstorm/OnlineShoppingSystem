...
@WebServlet("/deleteShopFromFavorite.action")
public class DeleteShopFromFavoriteAction extends HttpServlet {

    public DeleteShopFromFavoriteAction() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sid != null) {
            UserService.deleteShopFromFavorite(uid, sid);
        }
