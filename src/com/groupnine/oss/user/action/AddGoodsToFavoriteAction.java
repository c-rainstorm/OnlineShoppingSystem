...
@WebServlet("/addGoodsToFavorite.action")
public class AddGoodsToFavoriteAction extends HttpServlet {

    public AddGoodsToFavoriteAction() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Goods.isGoodsIdWellFormed(gid)) {
            UserService.addGoodsToFavorite(uid, gid);
        }
