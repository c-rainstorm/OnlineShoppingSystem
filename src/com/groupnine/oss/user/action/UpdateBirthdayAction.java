...
@WebServlet("/updateBirthday.action")
public class UpdateBirthdayAction extends HttpServlet {
    public UpdateBirthdayAction() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Users.isBirthdayWellFormed(birthday)) {
            UserService.updateUserInfo(uid, "birthday", birthday);
        }
