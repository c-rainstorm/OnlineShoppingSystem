...
<div class="container main">
    <div class="row">
        <div class="col-md-offset-8 col-md-offset-8">
            <a href="pay-result.jsp" class="btn btn-success payAll" target="_blank">全部支付</a>
        </div>
    </div>
...
<script type="text/javascript " src="../../style/js/payOrder.js "></script>
